...
public class NormalMainAdapter extends RecyclerView.Adapter<NormalMainAdapter.MainViewHolder> {

  private List<GalleryImage> items;

  public NormalMainAdapter() {
    items = new ArrayList<>();
  }
  ...
  static class MainViewHolder extends RecyclerView.ViewHolder {
    ...
    MainViewHolder(MainItemBinding binding) {
